...
namespace EmployeeManagement.Api
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            // HU
            // Használjuk AddScoped() metódust, mert azt szeretnénk, hogy a példány élő és elérhető legyen az adott HTTP-kérés teljes hatókörében. Egy másik új HTTP-kérés esetén a EmployeeRepository class lesz megadva, és a HTTP-kérés teljes hatókörében elérhető lesz.
