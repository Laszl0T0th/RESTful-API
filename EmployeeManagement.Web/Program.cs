...
namespace Company.WebApplication1
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            // Ahhoz, hogy a felhasználó bejelentkezhessen, felhasználói fiókra van szüksége a rendszerünkben. Így a felhasználó kitölt egy regisztrációs űrlapot a kívánt felhasználónevével és jelszavával, és elküldi az űrlapot a szerverre. A szerver ezután kivonatolja a jelszót, és eltárolja az adatbázisban. A kivonatolás megakadályozza a jelszólopást. Még ha egy támadó feltöri is a rendszert, és hozzáfér a rendszeréhez, akkor sem tudja ellopni a jelszavakat, mert azok kivonatolva vannak. A kivonatolás eltér a titkosítástól.
            // Titkosítás vs kivonatolás
            // A titkosítás visszafordítható, azaz ami titkosítva van, az visszafejthető. A kivonat egyirányú. Visszafordíthatatlan. A kivonat összekeveri az egyszerű szöveget, hogy egyedi üzenetkivonatot készítsen. Ha erős algoritmussal hajtják végre, akkor nincs mód a kivonatolási folyamat visszafordítására, hogy felfedje az eredeti jelszót.
            // A támadó véletlenszerű jelszavakat kivonatozhat, majd összehasonlíthatja a kivonatokat a jelszó feltöréséhez.
            // Ha véletlenszerű sót adunk a kivonatolási folyamathoz, a generált hash nem lesz ugyanaz, még akkor sem, ha az egyszerű szöveges jelszavak azok.
            // Bejelentkezés
            // A regisztrált felhasználónév és jelszó ezután használható a bejelentkezési űrlapon. A bejelentkezési űrlap felkerül a szerverre. A szerver megkeresi a felhasználónevet az adatbázisban. Kivonatolja a megadott jelszót, és összehasonlítja az adatbázisban már kivonatolt jelszóval. Ha egyeznek, akkor a rendszer tudja, hogy a felhasználó az, akinek állítja magát, ellenkező esetben a hozzáférést megtagadja a 401-es HTTP állapotkód elküldésével.
            ...
            // Utólagos kérések
            // A böngésző minden további kérésre automatikusan elküldi a cookie-t a szervernek. A szerver beolvassa a hozzáférési jogkivonatot a cookie-ból, és összeveti az adott felhasználóhoz társított adatbázisban lévővel. Ha megegyeznek, a hozzáférés biztosított.
            // Miután a felhasználó kijelentkezik az alkalmazásból, mind a hitelesítési cookie, mind a hozzáférési jogkivonat törlődik az adatbázisban.
            // Cookie-hitelesítés vagy token hitelesítés
            // A következő a Blazor alkalmazás architektúrája. Van egy Blazor webalkalmazásunk és egy webes API-nk. A Blazor webalkalmazás WEB API-t hív. Client <-> Blazor Server <-> Restful Service <-> Database
            //Attól függően, hogy hogyan szeretné skálázni az alkalmazást, a blazor webalkalmazás és a webes API is telepítve lehet ugyanazon a kiszolgálón vagy különböző kiszolgálókon. Az igényektől függően, ha önállóan szeretné fel- és lefelé skálázni ezt a két alkalmazást, akkor előfordulhat, hogy különböző kiszolgálókra kell telepítenie őket.
            //Ha különböző szervereken vannak telepítve, akkor nem tudjuk ugyanazt a cookie-hitelesítést használni a Blazor webalkalmazás és a webes API hitelesítésére. Ennek az az oka, hogy az egyik tartomány által létrehozott cookie-hoz nem férhet hozzá egy másik tartomány.
            ...
            //Következő videóinkban süti-hitelesítést fogunk megvalósítani, hogy megvédjük blázor webalkalmazásunkat, és token hitelesítést webes API-nk védelme érdekében.
            #endregion
            ...
            // HU
            // Kattintson a jobb gombbal a Blazor webes projektre, és válassza a lehetőséget Add - New Scaffolded Item...
            // Válasszon mind a bal, mind a középső ablaktáblák közül az Elem párbeszédpanelen.IdentityAdd New Scaffolded
            // Az Identitás hozzáadása párbeszédpanelen
            // Check - Ezzel hozzáadja az összes Identity nézetet és osztályt a projektünkhöz, így módosíthatjuk őket, hogy megfeleljenek az alkalmazásspecifikus követelményeinknek. Minden fájl felülbírálása
            // Adatkörnyezetosztály - Ha a projektnek már van adatkörnyezet-osztálya, válassza ki azt a legördülő listából. Ellenkező esetben kattintson a pluszjelre a létrehozásához.
            // Kattintson a Hozzáadás gombra
            // A generált identitásfájlok a mappában tárolódnak.Areas/Identity
            // Identitásáttelepítések hozzáadása és végrehajtása
            // Nyissa meg és hajtsa végre a következő parancsot add a migrationPackage Manager Console
            ...
            // HU
            // Az osztály metódusában és metódusaiban hitelesítési és engedélyezési middleware-összetevőket ad hozzá a kérelemfeldolgozási folyamathoz.
